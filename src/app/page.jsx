    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <div className="mb-6 sm:mb-8 animate-fade-in">
            <div className="inline-flex items-center px-4 sm:px-5 py-2.5 rounded-full bg-gradient-to-r from-purple-500/30 to-blue-500/30 border border-purple-400/50 backdrop-blur-xl mb-4 sm:mb-6 shadow-lg shadow-purple-500/20 hover:shadow-purple-500/40 transition-all duration-300 hover:scale-105">
              ...
              <span className="font-semibold text-xs sm:text-sm bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent">Premium AI Prompts Marketplace</span>
            </div>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black mb-6 sm:mb-8 leading-tight animate-fade-in-up">
            ...
            <span className="block bg-gradient-to-r from-cyan-200 via-blue-300 to-purple-300 bg-clip-text text-transparent drop-shadow-2xl mt-2">
              Instant Results
            </span>
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-white/80 mb-8 sm:mb-10 max-w-xl sm:max-w-3xl mx-auto leading-relaxed px-4 sm:px-0 font-light animate-fade-in-up delay-200">
            Buy, sell, and execute AI prompts in one platform. Get results in <span className="text-purple-400 font-semibold">zepto seconds</span> with our built-in execution engine.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5 px-4 sm:px-0 animate-fade-in-up delay-300">
            <Button 
              size="lg" 
              onClick={handleStartCreating}
              className="group w-full sm:w-auto text-base sm:text-lg font-bold px-8 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-purple-600 via-blue-600 to-purple-600 bg-size-200 bg-pos-0 hover:bg-pos-100 border-0 rounded-2xl shadow-2xl shadow-purple-500/50 transition-all duration-500 hover:shadow-purple-500/80 hover:scale-110 hover:-translate-y-1"
            >
              <ShoppingBag className="w-5 h-5 sm:w-6 sm:h-6 mr-2 group-hover:rotate-12 transition-transform duration-300" />
              Browse Prompts
            ...
            <Button 
              ...
              className="group w-full sm:w-auto text-base sm:text-lg font-bold px-8 sm:px-10 py-4 sm:py-5 bg-white/5 border-2 border-white/30 text-white hover:bg-white/10 hover:border-purple-400 rounded-2xl backdrop-blur-xl transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-white/20"
            >
              <Rocket className="w-5 h-5 sm:w-6 sm:h-6 mr-2 group-hover:-translate-y-1 transition-transform duration-300" />
              Start Selling
            </Button>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16 sm:mb-20 px-4 sm:px-0">
          <div className="group text-center p-8 sm:p-10 bg-gradient-to-br from-purple-900/30 via-black/50 to-black/50 backdrop-blur-2xl border border-purple-500/30 rounded-3xl hover:border-purple-400/60 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/30 hover:scale-105 hover:-translate-y-2">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-purple-600 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-purple-500/50 group-hover:shadow-purple-500/80 group-hover:scale-110 transition-all duration-500 group-hover:rotate-6">
              <Zap className="h-8 w-8 sm:h-10 sm:w-10 text-white group-hover:animate-pulse" />
            </div>
            <h3 className="text-xl sm:text-2xl font-bold mb-4 text-white group-hover:text-purple-300 transition-colors duration-300">Instant Execution</h3>
            <p className="text-base sm:text-lg text-white/70 leading-relaxed group-hover:text-white/90 transition-colors duration-300">
              Buy and execute prompts in one click. No copy-paste needed. Get results in <span className="text-purple-400 font-semibold">zepto seconds</span>.
            </p>
          </div>

          <div className="group text-center p-8 sm:p-10 bg-gradient-to-br from-green-900/30 via-black/50 to-black/50 backdrop-blur-2xl border border-green-500/30 rounded-3xl hover:border-green-400/60 transition-all duration-500 hover:shadow-2xl hover:shadow-green-500/30 hover:scale-105 hover:-translate-y-2">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-green-600 to-emerald-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-green-500/50 group-hover:shadow-green-500/80 group-hover:scale-110 transition-all duration-500 group-hover:rotate-6">
              <ShoppingBag className="h-8 w-8 sm:h-10 sm:w-10 text-white group-hover:animate-pulse" />
            </div>
            <h3 className="text-xl sm:text-2xl font-bold mb-4 text-white group-hover:text-green-300 transition-colors duration-300">Premium Marketplace</h3>
            <p className="text-base sm:text-lg text-white/70 leading-relaxed group-hover:text-white/90 transition-colors duration-300">
              Discover curated, high-quality prompts for marketing, coding, writing, and more.
            </p>
          </div>

          <div className="group text-center p-8 sm:p-10 bg-gradient-to-br from-yellow-900/30 via-black/50 to-black/50 backdrop-blur-2xl border border-yellow-500/30 rounded-3xl hover:border-yellow-400/60 transition-all duration-500 hover:shadow-2xl hover:shadow-yellow-500/30 hover:scale-105 hover:-translate-y-2 sm:col-span-2 lg:col-span-1">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-yellow-600 to-orange-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-yellow-500/50 group-hover:shadow-yellow-500/80 group-hover:scale-110 transition-all duration-500 group-hover:rotate-6">
              <DollarSign className="h-8 w-8 sm:h-10 sm:w-10 text-white group-hover:animate-pulse" />
            </div>
            <h3 className="text-xl sm:text-2xl font-bold mb-4 text-white group-hover:text-yellow-300 transition-colors duration-300">Monetize Your Skills</h3>
            <p className="text-base sm:text-lg text-white/70 leading-relaxed group-hover:text-white/90 transition-colors duration-300">
        ...
        {/* CTA */}
        <div className="relative text-center bg-gradient-to-br from-purple-900/50 via-blue-900/30 to-black/50 backdrop-blur-2xl border-2 border-purple-500/50 rounded-3xl sm:rounded-[2rem] shadow-2xl shadow-purple-500/40 p-8 sm:p-12 lg:p-16 mx-4 sm:mx-0 overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-white/80 mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed px-4 sm:px-0 font-light">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
              <Button 
                size="lg"
                onClick={handleStartCreating}
                className="group w-full sm:w-auto text-base sm:text-xl font-bold px-10 sm:px-12 py-5 sm:py-6 bg-gradient-to-r from-purple-600 via-blue-600 to-purple-600 bg-size-200 bg-pos-0 hover:bg-pos-100 border-0 rounded-2xl shadow-2xl shadow-purple-500/60 transition-all duration-500 hover:shadow-purple-500/90 hover:scale-110 hover:-translate-y-1 max-w-xs sm:max-w-none"
              >
                <ShoppingBag className="w-6 h-6 sm:w-7 sm:h-7 mr-2 group-hover:rotate-12 transition-transform duration-300" />
                Explore Marketplace
                <ArrowRight className="w-6 h-6 sm:w-7 sm:h-7 ml-2 group-hover:translate-x-1 transition-transform duration-300" />
              </Button>
              <Button 
                variant="outline"
                size="lg"
                onClick={handleSignIn}
                className="group w-full sm:w-auto text-base sm:text-xl font-bold px-10 sm:px-12 py-5 sm:py-6 bg-white/10 border-2 border-white/40 text-white hover:bg-white/20 hover:border-purple-400 rounded-2xl backdrop-blur-xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-white/30 max-w-xs sm:max-w-none"
              >
                <Rocket className="w-6 h-6 sm:w-7 sm:h-7 mr-2 group-hover:-translate-y-1 transition-transform duration-300" />
                Start Selling
              </Button>
            </div>
          </div>
